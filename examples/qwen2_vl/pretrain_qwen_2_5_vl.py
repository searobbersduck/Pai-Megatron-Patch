...
from megatron_patch.model.qwen2_5_vl.model import Qwen2VLModel
...
# copied from https://github.com/huggingface/transformers/blob/d1b92369ca193da49f9f7ecd01b08ece45c2c9aa/src/transformers/models/qwen2_5_vl/modeling_qwen2_5_vl.py#L1509
def get_rope_index(
    ...
    if input_ids is not None and (image_grid_thw is not None or video_grid_thw is not None):
        ...
        for i, input_ids in enumerate(total_input_ids):
            ...
            for _ in range(image_nums + video_nums):
                ...
                time_tensor = expanded_range * second_per_grid_t * args.vision_tokens_per_second
